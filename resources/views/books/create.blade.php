        ...
        <form action="/books" method="post">
            <table class="table">
                ...
                <tbody class="table">
                    ...
                    <tr>
                        <td>
                            <select name="author_id" id="author_id" class="form-control">
                                <option value="" class="form-group" selected>Select author</option>
                    ...
                    <tr>
                        <td>
                            <select name="category_id" id="category_id" class="form-control">
                                <option value="" class="form-group" selected>Select category</option>
                    ...
                    <tr>
                        @csrf
                        <td> <a href="/books" class="btn btn-sm btn-outline-secondary mr-2">Back</a><button type="submit" class="btn btn-sm btn-success">Add book</button></td>
                    </tr>
                </tbody>
            </table>
        </form>
